    ...
    <div style="position: relative; left: 35%; width: 330px ">
        <form method="POST" action = "<?php $_PHP_SELF ?>">
            ...
            <div class="input-field">
                ...
                <a class="btn tooltipped red" data-position="bottom" data-delay="50" style="position: relative; left: 15%" data-tooltip="Any Penetration testing tool wil help.">Hint</a>
            </div>
        </form>
