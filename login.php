...
<div class="test">
    ...
    <br>
    <h5 class="teal-text" style="position :relative; left: 20px;">Hello!</h5>
	<h5 class="teal-text" style="position :relative; left: 20px;">Please Enter your Login credentials</h5>
    <br>
...
<?php
		...
		$str=session_id();
		ob_start();
		header("Location: success.php?PHPSESSID=".$str); // Redirecting To Other Page
		} else {
