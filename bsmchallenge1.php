...
<div class="test">
    <nav>
        <div class="nav-wrapper">
            <a href="#" class="brand-logo center">Broken Session Management Challenge 1</a>
        </div>
    </nav>
    <br>
    <h5 class="teal-text" style="position :relative; left: 20px;">Gain access to the Administrator account</h5>
    <br>
    ...
    <div style="position: relative; left: 35%; width: 330px ">
        <form method="POST" action = "<?php $_PHP_SELF ?>">
            ...
            <div class="input-field">
				...
				<a class="btn tooltipped red" data-position="bottom" data-delay="50" style="position: relative; left: 15%" data-tooltip="Think of common Administrator authentication information">Hint</a>	
			</div>
        </form>
...
<?php
		...
		$password=$_POST['pwd'];
		$sql = "select * from challenge_users where password='123456789' AND userid='admin'";
		$result = $conn->query($sql);        
        if ($result->num_rows == 1) {
		//$_SESSION['login_user']=$username;
		ob_start();
		$message="Successfully completed Challenge 1!";
