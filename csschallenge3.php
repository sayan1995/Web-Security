...
<div class="test">
    <nav>
        <div class="nav-wrapper">
            <a href="#" class="brand-logo center">Cross Site Scripting Challenge 3</a>
        </div>
    </nav>
    <br>
    ...
    <div style="position: relative; left: 35%; width: 330px ">
        <form method="POST">
            ...
            <div class="input-field">
                ...
                <a class="btn tooltipped red" data-position="bottom" data-delay="50" style="position: relative; left: 15%" data-tooltip="I wish I could give you one..">Hint</a>
            </div>
        </form>
    </div>
    <?php 
