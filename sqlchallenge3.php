...
<div class="test">
    <nav>
        <div class="nav-wrapper">
            <a href="#" class="brand-logo center">SQL Injection Challenge 3</a>
        </div>
    </nav>
    <br>
    ...
    <h5 class="red-text" style="position :relative; left: 20px;">Note: There is parameterization of Queries</h5>
    <br>
    ...
    <?php
        ...
        $stmt = $conn->prepare('select creditcardno from tutorial_users where userid=?');
