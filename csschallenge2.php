...
<head>
    ...
    <script>
        window.alert = function(msg) {
            Materialize.toast('Successfully Completed Challenge :)', 4000);
        };
...
<div class="test">
    <nav>
        <div class="nav-wrapper">
            <a href="#" class="brand-logo center">Cross Site Scripting Challenge 2</a>
        </div>
    </nav>
    <br>
    <h5 class="teal-text" style="position :relative; left: 20px;">Inject a Script to alert "you're hacked"</h5>
    <br>
    ...
    <div style="position: relative; left: 35%; width: 330px ">
        <form method="POST">
            <div class="input-field col s6">
              ...
              <label for="comment">Enter Query</label>
            </div>
            <div class="input-field">
                <button class="waves-effect waves-light btn blue" type="submit" style="position: relative; left: 15%">Search</button>
                <a class="btn tooltipped red" data-position="bottom" data-delay="50" style="position: relative; left: 15%" data-tooltip="User Input is being formatted slightly.">Hint</a>
            </div>
        </form>
    </div>
    <?php 
        if(isset($_POST['comment'])){
            $data = preg_replace('/script/i', '', $_POST['comment']);
            echo "<h5>sorry no results found for : ".$data."</h5>";
        }
    ?>
</div>
</body>
